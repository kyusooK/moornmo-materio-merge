                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                            ...
                            <td class="whitespace-nowrap" label="상품 정보">
                                <ProductId :editMode="editMode" v-model="val.productId"></ProductId>
                            </td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Inventory 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
